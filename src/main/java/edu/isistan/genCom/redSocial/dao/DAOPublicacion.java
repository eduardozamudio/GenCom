...
/**
 * Home object for domain model class Publicaciones.
 * @see main.java.edu.isistan.genCom.redSocial.Publicacion
 * @author Hibernate Tools
 */
public class DAOPublicacion {

	private static final Log log = LogFactory.getLog(DAOPublicacion.class);
	...
	public void persist(Publicacion transientInstance) {
		log.debug("persisting Publicaciones instance");
		try {
	...
	public void attachDirty(Publicacion instance) {
		log.debug("attaching dirty Publicaciones instance");
		try {
	...
	public void attachClean(Publicacion instance) {
		log.debug("attaching clean Publicaciones instance");
		try {
	...
	public void delete(Publicacion persistentInstance) {
		log.debug("deleting Publicaciones instance");
		try {
	...
	public Publicacion merge(Publicacion detachedInstance) {
		log.debug("merging Publicaciones instance");
		try {
	...
	public Publicacion findById(long id) {
		log.debug("getting Publicaciones instance with id: " + id);
		try {
			Publicacion instance = (Publicacion) sessionFactory
					.getCurrentSession()
					.get("main.resources.Publicaciones", id);
			if (instance == null) {
	...
	public List findByExample(Publicacion instance) {
		log.debug("finding Publicaciones instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("main.resources.Publicaciones")
