...
/**
 * Abstract factory for Poblational model creators
 * @author eduardo
 *
 */
public abstract class ModeloCreator {
	protected String nombre;
	
	public abstract EvolutionEngine getInstance(RedFitness evaluador,
			CandidateFactory<List> factory, EvolutionaryOperator pipeline,
