...
/**
 * Crossover operator container
 * 
 * @author zamu
 *
 */
public class OperadorEvo {
	private Map<String, OperatorCreator> creators;

	public OperadorEvo() {
		this.creators = new HashMap<>();
	}
	
	public void set(String nombre, OperatorCreator creator){
		this.creators.put(nombre, creator);
	}
	
	public OperatorCreator get(String nombre){
