...
public class ModeloPoblacional {
	private Map<String, ModeloCreator> creators;
	
	public ModeloPoblacional() {
		this.creators = new HashMap<>();
	}
	
	public void set(String nombre, ModeloCreator creator){
		this.creators.put(nombre, creator);
	}
	
	public ModeloCreator get(String nombre){
